...
@section('content')
    ...
    @endif
			...
			<div class="register"> {{-- panel panel-default center-block --}}
            	<h2 class="panel-head"><img src="/images/main/i-register.png">
                @if(isset($userObj))
					ユーザー登録情報の編集
                @else
                	新規ユーザー登録
                ...
                {!! Form::open(array('class'=>'form-d')) !!}
                    ...
                    <table class="table-d">
                        ...
                        <button type="submit" class="center-block send-btn">
                                    @if(isset($userObj))
                                    内容を変更する
                                    @else
                                    内容を確認する
