...
class CreateStudyentriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('studyentries', function (Blueprint $table) {
            $table->increments('id');
            
            $table->integer('user_id')->nullable()->default(NULL);
            $table->string('user_name')->nullable()->default(NULL);
            $table->string('user_mail')->nullable()->default(NULL);
            $table->integer('iroha_id')->nullable()->default(NULL);
            $table->string('study_name')->nullable()->default(NULL);
